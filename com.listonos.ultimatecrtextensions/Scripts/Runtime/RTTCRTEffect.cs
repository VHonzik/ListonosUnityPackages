...
namespace Listonos.UltimateCRTExtensions
{
	public class RTTCRTEffect : MonoBehaviour
	{
		public static void SetupDefaultPreset(RTTCRTEffect effect)
		{
		...
		public static void SetupKitchenTVPreset(RTTCRTEffect effect)
		{
			effect.blurSize = 0.7f;
			effect.blurStrength = 0.6f;
			effect.bleedingSize = 0.75f;
		...
		public static void SetupColorTVPreset(RTTCRTEffect effect)
		{
		...
		public static void SetupOldTVPreset(RTTCRTEffect effect)
		{
			effect.blurSize = 0.9f;
			effect.blurStrength = 0.8f;
		...
		public static void SetupHighEndMonitorPreset(RTTCRTEffect effect)
		{
		...
		public static void SetupArcadeDisplayPreset(RTTCRTEffect effect)
		{
		...
		public static void SetupBrokenBlackAndWhitePreset(RTTCRTEffect effect)
		{
			effect.blurSize = 0.9f;
		...
		public static void SetupGreenTerminalPreset(RTTCRTEffect effect)
		{
			effect.blurSize = 0.9f;
			effect.blurStrength = 1.0f;
		...
		void OnPostRender()
		{
			if (SourceTexture && TargetRenderTexture)
			{
				ProcessEffect(SourceTexture, TargetRenderTexture);
			}
		}
